const covid19ImpactEstimator = (data) => {
  ...
  //const dollarsIFImpact = Math.trunc(infectionBRTimeImpact * avgUSD * avgPop * days);
  //const dollarsIFSevereImpact = Math.trunc(infectionBRTimeSevereImpact * avgUSD * avgPop * days);
  return {
    data: input,
    impact: {
